...
const styles = StyleSheet.create({ screen: { backgroundColor: "#F8F9FC", flex: 1 }, content: { alignSelf: "center", gap: 11, maxWidth: 760, padding: 18, width: "100%" }, freshness: { color: "#6C786F", fontSize: 11, ...font("700") }, error: { backgroundColor: "#FFF4E3", borderRadius: 12, color: "#754E12", fontSize: 11, lineHeight: 16, padding: 12 }, empty: { backgroundColor: "#F0F4F1", borderRadius: 16, gap: 6, padding: 17 }, emptyTitle: { color: "#304338", fontSize: 14, ...font("800") }, emptyBody: { color: "#69766E", fontSize: 12, lineHeight: 18 } });
