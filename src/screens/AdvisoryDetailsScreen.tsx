...
export function AdvisoryDetailsScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      >
        <View style={[styles.hero, tintedCard(color)]}>
...
const styles = StyleSheet.create({
  ...
  hero: { borderRadius: 20, borderWidth: 1, gap: 15, padding: 20 },
  ...
  severity: { fontSize: 10, ...font("900"), letterSpacing: 0.9, textTransform: "uppercase" },
  sourceLabel: { color: "#748078", fontSize: 9, ...font("800"), letterSpacing: 0.8 },
  headline: { color: "#17271B", fontSize: 22, ...font("800"), letterSpacing: -0.5, lineHeight: 29 },
  areaBlock: { borderTopColor: "rgba(29, 48, 35, 0.10)", borderTopWidth: StyleSheet.hairlineWidth, gap: 5, paddingTop: 13 },
  areaLabel: { color: "#7B867E", fontSize: 8, ...font("900"), letterSpacing: 1 },
  area: { color: "#4D5D52", fontSize: 13, ...font("700"), lineHeight: 19 },
  section: { gap: 9 },
  sectionTitle: { color: "#1D3023", fontSize: 17, ...font("800"), letterSpacing: -0.2 },
  ...
  metaLabel: { color: "#7A857D", fontSize: 8, ...font("900"), letterSpacing: 0.9 },
  metaValue: { color: "#26382B", fontSize: 12, ...font("800"), lineHeight: 17 },
  ...
  textEyebrow: { color: "#748078", fontSize: 8, ...font("900"), letterSpacing: 1 },
  instructionEyebrow: { color: "#986019" },
  cardTitle: { color: "#203326", fontSize: 17, ...font("900"), letterSpacing: -0.2 },
  ...
  verifiedGlyph: { color: "#FFFFFF", fontSize: 14, ...font("900") },
  provenanceCopy: { flex: 1, gap: 3 },
  provenanceTitle: { color: "#24452F", fontSize: 13, ...font("900") },
  provenanceText: { color: "#486451", fontSize: 11, ...font("700"), lineHeight: 16 },
  ...
  missingEyebrow: { color: "#7A857D", fontSize: 9, ...font("900"), letterSpacing: 1 },
  missingTitle: { color: "#203326", fontSize: 18, ...font("800"), lineHeight: 24 },
