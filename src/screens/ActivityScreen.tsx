...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: "#17633A", fontSize: 10, fontWeight: "900", letterSpacing: 1.3 },
  title: { color: "#17271B", fontSize: 30, fontWeight: "800", letterSpacing: -0.9, lineHeight: 36, marginTop: 5 },
  ...
  refreshGlyph: { color: "#17633A", fontSize: 20, fontWeight: "700", lineHeight: 20 },
  refreshText: { color: "#17633A", fontSize: 9, fontWeight: "800", marginTop: 3 },
  ...
  summaryNumber: { color: "#173D25", fontSize: 34, fontWeight: "800", letterSpacing: -1.2, lineHeight: 38 },
  summaryLabel: { color: "#58665D", fontSize: 11, fontWeight: "700" },
  summaryMeta: { alignItems: "flex-end", gap: 3, paddingBottom: 2 },
  summaryMetaStrong: { color: "#253A2B", fontSize: 11, fontWeight: "800" },
  ...
  filterPanelTitle: { color: "#203326", fontSize: 14, fontWeight: "900" },
  ...
  filterSection: { gap: 9 },
  filterLabel: { color: "#77837B", fontSize: 8, fontWeight: "900", letterSpacing: 0.9 },
  logHeading: { alignItems: "baseline", flexDirection: "row", justifyContent: "space-between", paddingTop: 3 },
  logTitle: { color: "#1D3023", fontSize: 18, fontWeight: "900", letterSpacing: -0.25 },
  logContext: { color: "#7A857D", fontSize: 9 },
  dayLabel: { color: "#58665D", fontSize: 11, fontWeight: "900", letterSpacing: 0.2, paddingBottom: 12, paddingLeft: 34, paddingTop: 12 },
  ...
  relativeTime: { color: "#17633A", fontSize: 10, fontWeight: "800" },
  provider: { color: "#879189", fontSize: 8, fontWeight: "900", letterSpacing: 0.7 },
  areaName: { color: "#1A3221", fontSize: 16, fontWeight: "900", letterSpacing: -0.25, lineHeight: 21, marginTop: 2 },
  areaBasis: { color: "#89928C", fontSize: 7, fontWeight: "800", letterSpacing: 0.55, textTransform: "uppercase" },
  observationType: { color: "#506057", fontSize: 11, fontWeight: "700", lineHeight: 16, marginTop: 4 },
  ...
  detailsText: { color: "#17633A", fontSize: 11, fontWeight: "800" },
  ...
  mapActionText: { color: "#51675A", fontSize: 11, fontWeight: "800" },
  ...
  emptyEyebrow: { color: "#738078", fontSize: 8, fontWeight: "900", letterSpacing: 0.9 },
  emptyTitle: { color: "#2D4133", fontSize: 16, fontWeight: "900", lineHeight: 22 },
