    ...
    <View style={styles.screen}>
      ...
      >
        ...
        {nodes.map((node) => {
          ...
          return (
            <TrackedMarker anchor={{ x: 0.5, y: 1 }} key={`${node.detection.id}:${selected}`} coordinate={{ latitude: node.detection.latitude, longitude: node.detection.longitude }} onPress={() => selectMapDetection(node.detection)} stopPropagation accessibilityLabel={`Satellite detection, ${intensityLabel(node.detection.intensityLevel)} intensity`}>
        ...
        {selectedDestination ? (
          <>
            ...
            <TrackedMarker coordinate={selectedDestination.coordinate} accessibilityLabel={`Destination: ${selectedDestination.name}`}><DestinationSignal /></TrackedMarker>
          </>
        ) : null}
        {userLocation ? <TrackedMarker coordinate={userLocation} title={userLocationLabel ?? "Your location"}><CurrentLocationSignal /></TrackedMarker> : null}
      </MapView>
...
const styles = StyleSheet.create({
  ...
  previewBannerText: { color: colors.surface, fontSize: 9, ...font("900"), letterSpacing: 0.7 },
  locationNotice: { backgroundColor: "rgba(255,246,228,0.97)", borderRadius: 10, paddingHorizontal: 11, paddingVertical: 9 },
  locationNoticeText: { color: "#7D4B00", fontSize: 11, ...font("700"), lineHeight: 16 },
  advisoryIndicator: { alignItems: "center", alignSelf: "flex-start", backgroundColor: "rgba(255,255,255,0.97)", borderRadius: 12, ...shadow(2), flexDirection: "row", gap: 7, paddingHorizontal: 11, paddingVertical: 9 },
  advisoryDot: { backgroundColor: "#B56714", borderRadius: 5, height: 9, width: 9 },
  advisoryIndicatorText: { color: "#503612", fontSize: 10, ...font("900") },
  ...
  mapLoadingTitle: { color: colors.forest, fontSize: 13, ...font("800"), lineHeight: 18 },
  ...
  mapRetryText: { color: colors.surface, fontSize: 11, ...font("800") },
  searchControl: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.97)", borderRadius: 15, ...shadow(2), flexDirection: "row", gap: 9, paddingHorizontal: 14, paddingVertical: 12 },
  searchGlyph: { color: colors.forestAccent, fontSize: 22 }, searchText: { color: "#33443A", flex: 1, fontSize: 13, ...font("700") }, searchArrow: { color: colors.forestAccent, fontSize: 24 },
  filterRow: { gap: 7, paddingRight: 14 }, filterDivider: { width: 2 }, filterChip: { backgroundColor: "rgba(255,255,255,0.95)", borderRadius: 15, paddingHorizontal: 11, paddingVertical: 8 }, filterChipSelected: { backgroundColor: colors.forest }, filterChipText: { color: "#46554B", fontSize: 10, ...font("800") }, filterChipTextSelected: { color: colors.surface },
  ...
  actions: { alignItems: "flex-end", gap: 9, position: "absolute" }, compactAction: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.97)", borderRadius: 12, ...shadow(2), justifyContent: "center", minHeight: 36, paddingHorizontal: 10 }, compactActionText: { color: colors.forest, fontSize: 9, ...font("900"), letterSpacing: 0.6 }, layerActionSelected: { backgroundColor: "rgba(20,83,45,0.96)" }, layerActionTextSelected: { color: colors.surface }, roundAction: { alignItems: "center", backgroundColor: colors.surface, borderRadius: 22, ...shadow(2), height: 44, justifyContent: "center", width: 44 }, roundActionText: { color: colors.forest, fontSize: 23, ...font("700") }, locationAction: { alignItems: "center", backgroundColor: colors.surface, borderRadius: 24, ...shadow(2), height: 48, justifyContent: "center", width: 48 }, locationActionText: { color: colors.destination, fontSize: 25, ...font("800") },
  legend: { alignItems: "flex-start", gap: 7, maxWidth: 250, position: "absolute" }, legendButton: { backgroundColor: "rgba(255,255,255,0.97)", borderRadius: 11, ...shadow(2), paddingHorizontal: 10, paddingVertical: 9 }, legendButtonText: { color: colors.forest, fontSize: 9, ...font("900"), letterSpacing: 0.7 }, legendCard: { backgroundColor: "rgba(255,255,255,0.97)", borderRadius: 14, ...shadow(2), gap: 8, padding: 12, width: 235 }, legendTitle: { color: colors.forestAccent, fontSize: 9, ...font("900"), letterSpacing: 0.8 }, legendRow: { alignItems: "center", flexDirection: "row", gap: 9 }, legendSignal: { alignItems: "center", borderRadius: 12, borderWidth: 2, height: 24, justifyContent: "center", width: 24 }, legendCore: { borderRadius: 5, height: 10, width: 10 }, legendLabel: { color: "#435148", fontSize: 11, ...font("700") }, legendNote: { color: "#66736B", fontSize: 10, lineHeight: 14, marginTop: 2 },
  mapHint: { backgroundColor: "rgba(255,255,255,0.97)", borderRadius: 14, padding: 13 }, mapHintTitle: { color: "#1B3020", fontSize: 13, ...font("800") }, mapHintText: { color: "#647168", fontSize: 11, lineHeight: 16, marginTop: 4 },
  sheet: { backgroundColor: colors.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, bottom: 0, left: 0, paddingBottom: 20, paddingTop: 18, position: "absolute", right: 0 }, sheetLandscape: { borderRadius: 24, bottom: 16, left: undefined }, handle: { alignSelf: "center", backgroundColor: "#D8E0DA", borderRadius: 2, height: 4, marginBottom: 14, width: 36 }, sheetHeader: { alignItems: "flex-start", flexDirection: "row", justifyContent: "space-between" }, sheetHeaderCopy: { flex: 1, paddingRight: 12 }, sheetEyebrow: { color: colors.forestAccent, fontSize: 10, ...font("800"), letterSpacing: 1.2 }, sheetTitle: { color: colors.charcoal, fontSize: 20, ...font("800"), marginTop: 3 }, close: { color: "#506056", fontSize: 28, lineHeight: 28 }, observed: { color: "#5D6D62", fontSize: 12, marginTop: 5 }, details: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 14 }, detail: { backgroundColor: "#F3F7F4", borderRadius: 10, flexGrow: 1, gap: 3, minWidth: "29%", padding: 10 }, detailLabel: { color: "#6A766D", fontSize: 9, ...font("800"), letterSpacing: 0.8 }, detailValue: { color: "#203326", fontSize: 11, ...font("800") }, detailButton: { alignItems: "center", backgroundColor: "#E8F2EA", borderRadius: 12, flexDirection: "row", justifyContent: "space-between", marginTop: 13, padding: 13 }, detailButtonText: { color: colors.forestAccent, fontSize: 13, ...font("800") }, destinationNote: { color: "#65736A", fontSize: 11, lineHeight: 16, marginTop: 11 },
  sheetArea: { color: colors.forest, fontSize: 15, ...font("900"), lineHeight: 20, marginTop: 9 },
  setupScreen: { alignItems: "center", backgroundColor: "#F5F8F5", flex: 1, justifyContent: "center", padding: 22 }, setupCard: { backgroundColor: colors.surface, borderRadius: 20, gap: 12, maxWidth: 520, padding: 22, width: "100%" }, setupTitle: { color: "#18301F", fontSize: 24, ...font("800"), lineHeight: 30 }, setupCopy: { color: "#607066", fontSize: 13, lineHeight: 20 }, setupButton: { alignItems: "center", backgroundColor: colors.forest, borderRadius: 13, padding: 14 }, setupButtonText: { color: colors.surface, fontSize: 13, ...font("800") },
});
