...
const styles = StyleSheet.create({
  ...
  source: { color: "#B9DCC1", flex: 1, fontSize: 8, ...font("800"), letterSpacing: 1, textAlign: "right" },
  divider: { backgroundColor: "rgba(255,255,255,0.15)", height: 1 },
  place: { color: "#FFFFFF", fontSize: 25, ...font("900"), letterSpacing: -0.7, lineHeight: 31 },
  observed: { color: "#CDEAD4", fontSize: 12, ...font("700") },
  tags: { flexDirection: "row", flexWrap: "wrap", gap: 7 },
  tag: { backgroundColor: "rgba(255,255,255,0.12)", borderRadius: 13, paddingHorizontal: 10, paddingVertical: 7 },
  tagText: { color: "#EAF7ED", fontSize: 10, ...font("800") },
  metrics: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  metric: { backgroundColor: "rgba(255,255,255,0.08)", borderRadius: 12, flexGrow: 1, gap: 3, minWidth: "29%", padding: 10 },
  metricLabel: { color: "#9FD0AA", fontSize: 7, ...font("900"), letterSpacing: 0.8 },
  metricValue: { color: "#FFFFFF", fontSize: 12, ...font("800") },
