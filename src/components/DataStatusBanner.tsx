...
const styles = StyleSheet.create({
  ...
  readyText: { color: "#17633A", flex: 1, fontSize: 12, fontWeight: "600", lineHeight: 18 },
  loading: { backgroundColor: "#EDF5FB" },
  loadingDot: { backgroundColor: "#2A6FAD" },
  loadingText: { color: "#245B8E", flex: 1, fontSize: 12, fontWeight: "600", lineHeight: 18 },
  warning: { backgroundColor: "#FFF6E4" },
  warningDot: { backgroundColor: "#BD7100" },
  warningText: { color: "#7D4B00", flex: 1, fontSize: 12, fontWeight: "600", lineHeight: 18 },
  error: { backgroundColor: "#FCEDEC" },
  errorDot: { backgroundColor: "#B42318" },
  errorText: { color: "#8B1E17", flex: 1, fontSize: 12, fontWeight: "600", lineHeight: 18 },
});
